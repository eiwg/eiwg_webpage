...
## Subteams
subteams <- c("Communications", "LateStage", "Reporting", "Estimation", "NonInferiority", "Training", "IntercurrentEvent", "EarlyPhase", "NorthAmerica", "StudyDesign")
subteams_names <- c("Communications", "HTA and RWE", "Reporting", "Estimation", "Non-inferiority", "Training", "Intercurrent event", "Estimands in Early Phase [I/II] & Clinical Pharmacology Studies", "North America", "Study Design")
```
